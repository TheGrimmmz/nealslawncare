...
function Contact() {
  return (
    <div className='contact-container'>
      <div>
        <h2 className='contact-title'><u>EVERYTHING YOUR HOME LAWN NEEDS</u></h2>
      </div>
      <p>*As of right now every service is quote based. Please call or schedule an appointment!*</p>
